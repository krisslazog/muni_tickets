...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Admin', href: route('admin.priority.index') },
    { title: 'Crear', href: route('admin.priority.create') },
];

//Crear nueva
function submitForm() {
    form.post(route('admin.priority.store'), {
        onSuccess: () => {
            form.reset(); // Limpia el formulario
            console.log('Priority creada correctamente');
        },
        onError: (errors) => {
