...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Crear', href: route('admin.areas.create') },
];
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div
            ...
            <div class="mb-6">
                <h1 class="text-2xl font-bold">Crear Nueva Área</h1>
                <p class="mt-1 text-sm text-muted-foreground">
                    Completa el formulario para agregar una nueva área de
                    ticket.
                </p>
            </div>
