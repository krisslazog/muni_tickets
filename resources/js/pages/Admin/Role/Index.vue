        ...
        <div class="mx-auto w-full max-w-full px-4 py-6 sm:max-w-xl md:max-w-2xl lg:max-w-4xl">
            ...
            <div>
                ...
                <p class="mt-1 text-gray-600 dark:text-gray-400">
                    Aquí puedes gestionar los roles de la organización.
                </p>
            </div>
            ...
            <div>
                ...
                <!--fin mensaje flash-->
                <!-- 6. Botón de Nueva Rol -->
                <div class="mb-4 flex justify-end">
                    <Button class="bg-green-600 text-white hover:bg-green-500" @click="newRole">
            ...
            <Table hover bordered responsive>
                ...
                <TableBody>
                    <TableRow v-for="role in props.roles" :key="role.id">
                        ...
                        <TableCell>
                            <span class="rounded px-2 py-1 text-xs font-medium" :class="role.status
