    ...
    <AppLayout>
        <div class="container mx-auto max-w-2xl px-4 py-8">
            ...
            >
                ...
                <div>
                    <Label for="requester_id" class="mb-2 block"
                        >Usuario Solicitante</Label
                    >
                    <Select v-model="form.requester_id" required>
                        <SelectTrigger>
                            <SelectValue placeholder="Selecciona el usuario" />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectItem
                                v-for="person in props.requesters"
                                :key="person.id"
                                :value="person.id.toString()"
                            >
                                {{ person.first_name }}
                                {{ person.last_name_paternal }}
                            </SelectItem>
                        </SelectContent>
                    </Select>
                    <div
                        v-if="form.errors.requester_id"
                        class="mt-1 text-sm text-red-600"
                    >
