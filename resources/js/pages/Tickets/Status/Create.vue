...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Crear', href: route('tickets.status.create') },
];

//Crear nueva prioridad
function submitForm() {
    submitdisabled.value = true;
    form.post(route('tickets.status.store'), {
        onSuccess: () => {
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
            <div class="mb-6">
                <h1 class="text-2xl font-bold">Crear Nuevo Estado</h1>
                <p class="mt-1 text-sm text-muted-foreground">
                    Completa el formulario para agregar un nuevo estado de
                    ticket.
                </p>
            </div>
